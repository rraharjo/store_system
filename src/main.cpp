...
int main()
{
    ...
    accounting::Entry *entry1 = new accounting::Entry(true, 100, accounting::enums::AccountTitles::ASSETS, accounting::enums::asInt(accounting::enums::AssetTAccount::CASH));
    accounting::Entry *entry2 = new accounting::Entry(false, 100, accounting::enums::AccountTitles::LIABILITIES, accounting::enums::asInt(accounting::enums::LiabilitiesTAccount::UNEARNEDREV));
